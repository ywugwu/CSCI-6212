...
The PlantTraits2024 Challenge, part of the FGVC11 workshop at CVPR 2024, provides 50,000 labeled images and also integrates ancillary geodata for predicting plant traits such as height, seed mass, leaf size, etc.

This report introduces our neural network model and data preprocessing methods. We will omit messy technical details such as hyperparameter tuning, concrete data analysis/processing, model selection, etc.
